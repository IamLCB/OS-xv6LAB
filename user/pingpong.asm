...
int main(int argc, char *argv[])
{
  ...
  12:	89258593          	addi	a1,a1,-1902 # 8a0 <malloc+0x102>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	6a0080e7          	jalr	1696(ra) # 6b8 <fprintf>
        exit(1);
  20:	4505                	li	a0,1
  ...
  2a:	06100793          	li	a5,97
  2e:	fef40423          	sb	a5,-24(s0)
    int ptc[2], ctp[2];  // Pipes: parent to child (ptc) and child to parent (ctp)

    // Create pipes
    pipe(ptc);
  32:	fe040513          	addi	a0,s0,-32
  36:	00000097          	auipc	ra,0x0
  3a:	358080e7          	jalr	856(ra) # 38e <pipe>
    pipe(ctp);
  3e:	fd840513          	addi	a0,s0,-40
  42:	00000097          	auipc	ra,0x0
  46:	34c080e7          	jalr	844(ra) # 38e <pipe>

    // Create child process
    int pid = fork();
  4a:	00000097          	auipc	ra,0x0
  4e:	32c080e7          	jalr	812(ra) # 376 <fork>
  52:	fca42a23          	sw	a0,-44(s0)

    if (pid > 0)
  56:	04a04763          	bgtz	a0,a4 <main+0xa4>
  ...
  5a:	ed59                	bnez	a0,f8 <main+0xf8>
    {                                            // Child process
        read(ptc[0], buf, 1);                    // Receive signal from parent
  5c:	4605                	li	a2,1
  5e:	fe840593          	addi	a1,s0,-24
  62:	fe042503          	lw	a0,-32(s0)
  66:	00000097          	auipc	ra,0x0
  6a:	330080e7          	jalr	816(ra) # 396 <read>
        printf("%d: received ping\n", getpid()); // Print received signal
  6e:	00000097          	auipc	ra,0x0
  72:	390080e7          	jalr	912(ra) # 3fe <getpid>
  76:	85aa                	mv	a1,a0
  78:	00001517          	auipc	a0,0x1
  7c:	85850513          	addi	a0,a0,-1960 # 8d0 <malloc+0x132>
  80:	00000097          	auipc	ra,0x0
  84:	666080e7          	jalr	1638(ra) # 6e6 <printf>
        write(ctp[1], buf, 1);                   // Send signal to parent
  88:	4605                	li	a2,1
  8a:	fe840593          	addi	a1,s0,-24
  8e:	fdc42503          	lw	a0,-36(s0)
  92:	00000097          	auipc	ra,0x0
  96:	30c080e7          	jalr	780(ra) # 39e <write>
        exit(0);
  9a:	4501                	li	a0,0
  9c:	00000097          	auipc	ra,0x0
  a0:	2e2080e7          	jalr	738(ra) # 37e <exit>
        write(ptc[1], buf, 1);                   // Send signal to child
  a4:	4605                	li	a2,1
  a6:	fe840593          	addi	a1,s0,-24
  aa:	fe442503          	lw	a0,-28(s0)
  ae:	00000097          	auipc	ra,0x0
  b2:	2f0080e7          	jalr	752(ra) # 39e <write>
        read(ctp[0], buf, 1);                    // Receive signal from child
  b6:	4605                	li	a2,1
  b8:	fe840593          	addi	a1,s0,-24
  bc:	fd842503          	lw	a0,-40(s0)
  c0:	00000097          	auipc	ra,0x0
  c4:	2d6080e7          	jalr	726(ra) # 396 <read>
        printf("%d: received pong\n", getpid()); // Print received signal
  c8:	00000097          	auipc	ra,0x0
  cc:	336080e7          	jalr	822(ra) # 3fe <getpid>
  d0:	85aa                	mv	a1,a0
  d2:	00000517          	auipc	a0,0x0
  d6:	7e650513          	addi	a0,a0,2022 # 8b8 <malloc+0x11a>
  da:	00000097          	auipc	ra,0x0
  de:	60c080e7          	jalr	1548(ra) # 6e6 <printf>
        wait(&pid);                              // Wait for child process to finish
  e2:	fd440513          	addi	a0,s0,-44
  e6:	00000097          	auipc	ra,0x0
  ea:	2a0080e7          	jalr	672(ra) # 386 <wait>
        exit(0);
  ee:	4501                	li	a0,0
  ...
  fc:	7f050513          	addi	a0,a0,2032 # 8e8 <malloc+0x14a>
 100:	00000097          	auipc	ra,0x0
 104:	5e6080e7          	jalr	1510(ra) # 6e6 <printf>
        exit(1);
 108:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 568:	39c70713          	addi	a4,a4,924 # 900 <malloc+0x162>
 ...
 5f4:	368b8b93          	addi	s7,s7,872 # 958 <digits>
 ...
 64a:	2b290913          	addi	s2,s2,690 # 8f8 <malloc+0x15a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 72a:	6027b783          	ld	a5,1538(a5) # d28 <freep>
 ...
 752:	00e6ea63          	bltu	a3,a4,766 <free+0x4a>
{
 ...
 794:	58f73c23          	sd	a5,1432(a4) # d28 <freep>
}
 798:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7be:	56e53503          	ld	a0,1390(a0) # d28 <freep>
 ...
 7ee:	53e90913          	addi	s2,s2,1342 # d28 <freep>
  if(p == (char*)-1)
 7f2:	5afd                	li	s5,-1
 ...
 802:	53278793          	addi	a5,a5,1330 # d30 <base>
 806:	00000717          	auipc	a4,0x0
 80a:	52f73123          	sd	a5,1314(a4) # d28 <freep>
 80e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 880:	4aa73623          	sd	a0,1196(a4) # d28 <freep>
      return (void*)(p + 1);
