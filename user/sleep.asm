...
int main (int argc, char *argv[]) {
  ...
  12:	7ca58593          	addi	a1,a1,1994 # 7d8 <malloc+0x106>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	5d4080e7          	jalr	1492(ra) # 5ec <fprintf>
        exit(1);
  20:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 396:	4be50513          	addi	a0,a0,1214 # 850 <digits>
 39a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49c:	36070713          	addi	a4,a4,864 # 7f8 <malloc+0x126>
 ...
 528:	32cb8b93          	addi	s7,s7,812 # 850 <digits>
 ...
 57e:	27690913          	addi	s2,s2,630 # 7f0 <malloc+0x11e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 65e:	5c67b783          	ld	a5,1478(a5) # c20 <freep>
 ...
 686:	00e6ea63          	bltu	a3,a4,69a <free+0x4a>
{
 ...
 6c8:	54f73e23          	sd	a5,1372(a4) # c20 <freep>
}
 6cc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f2:	53253503          	ld	a0,1330(a0) # c20 <freep>
 ...
 722:	50290913          	addi	s2,s2,1282 # c20 <freep>
  if(p == (char*)-1)
 726:	5afd                	li	s5,-1
 ...
 736:	4f678793          	addi	a5,a5,1270 # c28 <base>
 73a:	00000717          	auipc	a4,0x0
 73e:	4ef73323          	sd	a5,1254(a4) # c20 <freep>
 742:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b4:	46a73823          	sd	a0,1136(a4) # c20 <freep>
      return (void*)(p + 1);
